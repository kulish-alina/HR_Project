        ...
        private static List<User> GetUsers(int count)
        {
            ...
            users.Add(
                    new User
                    {
                        ...
                        Password = "admin",
                        PhoneNumbers = new List<PhoneNumber> { new PhoneNumber { Number = "380" + GetRandomNumbers(7) } },
        ...
        private static List<Candidate> GetCandidates(int count)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                var candidate = new Candidate
                {
                    ...
                    MiddleName = names.GetRandom(),
                    PhoneNumbers =
                        Enumerable.Repeat(new PhoneNumber { Number = "380" + GetRandomNumbers(7) }, RandomNumber(0, 5))
                            .Distinct()
                            .ToList(),
