...
describe('Filter: arrayAsString', function() {
   ...
   it('should be able to show only location', function() {
   ...
   it('should be able to show only email', function() {
      expect(_arrayAsString(arr, 'email'))
         .toBe('antonov@mail.be1, antonov@mail.be2, antonov@mail.be3, antonov@mail.be4, antonov@mail.be5');
   });

   it('should be able to show only login', function() {
      expect(_arrayAsString(arr, 'login'))
         .toBe('dant1, dant2, dant3, dant4, dant5');
   });

   it('should be able to show only logins, includes "/" after each word', function() {
      expect(_arrayAsString(arr,'login','/'))
         .toBe('dant1/dant2/dant3/dant4/dant5');
   });

   it('should be able to show array as string', function() {
      expect(_arrayAsString(['dant1', 'dant2', 'dant3', 'dant4', 'dant5']))
         .toBe('dant1, dant2, dant3, dant4, dant5');
   });

   it('should be able to show array as string, includes "/" after each word', function() {
